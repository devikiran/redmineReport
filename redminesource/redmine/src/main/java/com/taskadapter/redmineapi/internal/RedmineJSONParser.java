...
public class RedmineJSONParser {
	...
	private static Date getDateOrNull(JSONObject obj, String field)
		...
		//System.out.println("value of the datestr is "+dateStr);
		if (dateStr == null)
			return null;
		try {
			...
			if (dateStr.endsWith("Z")) {
				//System.out.println("in the 2nd if");
				dateStr = dateStr.substring(0, dateStr.length() - 1)
						+ "GMT-00:00";
			} else {
				//System.out.println("in the 2nd else");
			...
			//System.out.println("last value "+dateStr);
			return RedmineDateUtils.SHORT_DATE_FORMAT_V2.get().parse(dateStr);
